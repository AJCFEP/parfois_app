...
# -------------------------------------------------
# Choose which similarity variant to inspect
# -------------------------------------------------
...
sim_mode = st.radio(
    ...
    index=2,  # default to Hybrid for this diagnostic page
    horizontal=True,
)
...
st.markdown(
    ...
    6. **Recommendations files**  
       For each product, we select the Top-4 nearest neighbours, and store the
       results in three CSV files (text-only, image-only, hybrid) with product
       IDs and similarity scores.

    7. **Streamlit app**  
       - The **main page** lets the user choose the similarity mode and shows similar products.  
       - This **Similarity Pipeline** page shows diagnostics, score analysis and an
